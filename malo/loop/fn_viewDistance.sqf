...
MALO_current_view_distance = (MALO_current_view_distance + (MALO_next_view_distance - MALO_current_view_distance) * MALO_delay / (MALO_CFG_dynamic_view_distance_smoothing /** 5*/));
